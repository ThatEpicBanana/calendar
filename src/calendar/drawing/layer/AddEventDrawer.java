...
public class AddEventDrawer extends SelectablePopupDrawer {
    ...
    public Canvas draw() {
        ...
        inset.text("  Add Event  ", Just.centeredOnRow(0), colors().highlightText(), highlight);
        ...
        inset.draw(wid.button("Confirm", Just.offsetFrom(Just.bottomLeft(), new Vec2(1, 0)), highlight, 4));
        inset.draw(wid.button("Abandon", Just.offsetFrom(Just.bottomRight(), new Vec2(-1, 0)), highlight, 5));
